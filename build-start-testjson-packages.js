         ...
         BUILD-START-TEST-JSON-PACKAGES

### **Initiate Build, Start, and Test Your App Using JSON Packages**

This guide explains how to configure your **`package.json`** files to initiate
**build**, **start**, and **test** processes for your app's **Frontend** (Angular),
**Backend** (Node.js), and **Smart Contracts**.
...
If you want to manage **Frontend**, **Backend**, and **Smart Contracts** together,
...
This setup ensures seamless **build**, **start**, and **test** workflows for
all components of your app. 
